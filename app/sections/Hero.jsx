    ...
    return (
        <section className="flex flex-col min-h-screen" id="/">
            <div className="w-full">
                <img src="/assets/shopping1.png" alt="HeroBg" className={`w-full h-[400px] md:h-[600px] absolute md:static left-0`} />
                ...
                <div className={`grid grid-cols-2 ${isOpen ? "md:grid-cols-2 lg:grid-cols-4" : "md:grid-cols-4"} justify-start items-center bg-softgreenl p-3 text-sm md:text-base lg:text-xl text-customBlue font-semibold`}>
                    <h2>Brand New</h2>
