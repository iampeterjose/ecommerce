...
const Footer = () => {
    ...
    return (
        <footer id="contact-us" className={`${isOpen ? "md:px-0" : "md:px-28"} py-10 font-sans w-full border-t border-customDark2`}>
            <div className="flex flex-wrap">
                <div className={`flex flex-col ${isOpen ? "flex-col lg:flex-row" : "md:flex-row"} justify-between gap-4 md:gap-6 mb-6`}>
                    {footerHeaders.map((header, i) => (
                        <div key={i} className="w-full">
                            <h2 className="text-lg text-customDark font-semibold mb-3">
                                {header.title}
                            </h2>
                ...
                <div className={`flex flex-col ${isOpen ? "md:flex-col lg:flex-row" : "md:flex-row"} justify-between border-t border-customDark2 text-customDark w-full text-xs my-2 py-4 gap-y-4`}>
