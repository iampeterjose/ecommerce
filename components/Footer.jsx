...
const Footer = () => {
    ...
    return (
        <footer id="contact-us" className={`${isOpen ? "md:px-0" : "md:px-28"} py-10 font-sans w-full border-t border-customBlue2`}>
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex relative w-full">
                            <input type="email" placeholder="Enter your email..." 
                                className="block px-2 py-1 pr-[84px] w-full text-base text-customBlue2 border-customBlue2 bg-white rounded-md border-2"
                            />
