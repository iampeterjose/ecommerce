...
const ProductDisplay = () => {
    ...
    return (
        <div className='w-full'>
            <h1 className='text-3xl font-semibold text-customBlue2'>{product.title}</h1>
            <span className='flex items-center gap-4'>
                <StarRating rating={product.rating} /><span className='text-sm'>({product.reviews.length} Reviews)</span>
            </span>
            <div className="mb-4 bg-lightBg flex justify-center border border-customBlue2 rounded-md">
